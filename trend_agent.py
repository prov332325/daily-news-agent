...
def fetch_news():
    print("🔍 GeekNews에서 최신 소식을 가져오는 중...")
    url = "https://news.hada.io/rss/news"
    headers = {'User-Agent': 'Mozilla/5.0'} # 나 사람이야! 라고 속이는 헤더
    ...
    try:
        ...
        news_list = [f"제목: {entry.title}\n링크: {entry.link}" for entry in feed.entries[:5]]
...
def analyze_with_gemini(news):
    ...
    1. 오직 아래 제공된 '뉴스 리스트'에 있는 실제 뉴스 5개만 요약할 것.
